...
acc_df, gyr_df = read_csv_files(files)
...
# Accelerometer:    12.500HZ //accelerometer measures in time gap of 0.08s
# Gyroscope:        25.000Hz //gyroscope measures in time gap of 0.04s
# therefore gyroscope measures in twice speed
